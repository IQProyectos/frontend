    ...
    async function getBio(userValue) {
        try {
            ...
            const projects = await axios.get(
                `http://iq-proyecto-api.herokuapp.com/api/private/filteredproject/${userValue.id}`,
                config
            );
        ...
        async function getUsers() {
            try {
                const users = await axios.get(
                    "http://iq-proyecto-api.herokuapp.com/api/private/users/",
                    config
                );
    ...
    const registerHandler = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.patch(
                `http://iq-proyecto-api.herokuapp.com/api/private/users/${userValue.id}`,
                {
